...
At its core, TPOT uses genetic programming (GP) [@tag:GPbook] to optimize a series of feature preprocessors and machine learning models with the objective of maximizing classification accuracy. 
