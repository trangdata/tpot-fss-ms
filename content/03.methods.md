...
## Manuscript drafting
The manuscript is written using Manubot [@url:https://greenelab.github.io/meta-review/], a software that supports open paper writing collaboration via GitHub using the Markdown language.
